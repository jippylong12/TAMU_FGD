...
# attempts to use google drive api to take pdf files and create an OCR
...
def googleOCR(folderName, pdfList):
    ...
    for pdf in pdfList:
        ...
        print("OCR file")
        file = insert_file(service, fileTitle, 'description',
                           rootFolder.get('id'), 'application/pdf', pdf)
